    ...
    public partial class Initiate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TaskLikes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TaskLikes_Tasks_TaskId",
                        column: x => x.TaskId,
                        principalTable: "Tasks",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TaskLikes_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SolutionComments_Solutions_SolutionId",
                        column: x => x.SolutionId,
                        principalTable: "Solutions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SolutionComments_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SolutionLikes_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SolutionComments_SolutionId",
                table: "SolutionComments",
                column: "SolutionId");

            migrationBuilder.CreateIndex(
                name: "IX_SolutionComments_UserId",
                table: "SolutionComments",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_SolutionLikes_SolutionId",
                table: "SolutionLikes",
                column: "SolutionId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TaskLikes_TaskId",
                table: "TaskLikes",
                column: "TaskId");

            migrationBuilder.CreateIndex(
                name: "IX_TaskLikes_UserId",
                table: "TaskLikes",
                column: "UserId");
